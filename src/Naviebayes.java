...
public class Naviebayes {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(classifier.searchAlgorithmTipText());
		...
		BufferedWriter bw=new BufferedWriter(new FileWriter("C:\\Users\\RamCharanTeja\\Desktop\\dm project\\baysnet.csv"));
